    ...
    <tbody>
        <tr>
            <td width="32%" valign="top">
                ...
                <ul class="nodot">
                    <li>
                        <a href="https://github.com/supercollider/supercollider/releases/download/Version-3.11.2/SuperCollider-3.11.2+BigSur.aed25fa.zip"><i class="icon-download-alt">.</i> 3.11.2+BigSur.aed25fa (macOS 11)</a> (sn*)
                    </li>
                    <li>
                        <a href="https://github.com/supercollider/supercollider/releases/download/Version-3.11.2/SuperCollider-3.11.2-macOS-signed.zip"><i class="icon-download-alt">.</i> 3.11.2 (macOS 10.13-10.15)</a> (sn*)
                    </li>
                    <li>
